...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>51.94558151692276</x>
        <y>98.64979111884323</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>55.934423816252824</x>
        <y>26.26748543076568</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.69450758656329</x>
        <y>64.16632799829232</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-15.777363172299793</x>
        <y>66.94396619117856</y>
        <z>0.0</z>
      </interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>117.01868330713299</x>
        <y>72.45447257601536</y>
        <z>0.0</z>
      </interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.5148220659486733 0.0 0.0 2.5148220659486733 57.50606889447389 7.927638257415371</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[COOJA_DIR]/build/scripts/2-hop.js</scriptfile>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
