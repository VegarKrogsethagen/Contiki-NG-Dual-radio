...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>15.254969155973638</x>
        <y>25.361101640723476</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>10.382015692637813</x>
        <y>24.823643551233022</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>25.202810805762613 0.0 0.0 25.202810805762613 -133.56203938487855 -479.89831920414224</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
