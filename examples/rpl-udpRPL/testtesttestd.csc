...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype878</identifier>
    ...
    <mote>
      <interface_config>
        ...
        <x>32.842286213197525</x>
        <y>33.419892998160925</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.381117171930775</x>
        <y>45.278165852270455</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype878</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>11.43045502604376 0.0 0.0 11.43045502604376 -256.0711397800473 -293.2773111634004</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
