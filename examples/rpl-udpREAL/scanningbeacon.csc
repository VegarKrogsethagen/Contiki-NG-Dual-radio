...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>25.273173328914286</x>
        <y>22.017062852059475</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.429250017304454</x>
        <y>21.76315962238202</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.72873947445758 0.0 0.0 5.72873947445758 -4.568469942248741 -48.40274434493395</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[COOJA_DIR]/build/scripts/beaconScan.js</scriptfile>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
