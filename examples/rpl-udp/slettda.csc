...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/../../../contiki_moddet/examples/rpl-udp/udp-client.c</source>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/../../../contiki_moddet/examples/rpl-udp/udp-server.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>63.62196034185725</x>
        <y>46.96493795024293</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>88.02395631230029</x>
        <y>46.392078707441236</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.680309107579907 0.0 0.0 9.680309107579907 -557.9896740572723 -297.36238930393455</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/../../../contiki_moddet/tools/cooja/build/scripts/simtest.js</scriptfile>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
