...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/tsch-startup/udp-client.c</source>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype839</identifier>
      <description>Cooja Mote Type #2</description>
      <source>[CONTIKI_DIR]/examples/tsch-startup/udp-server.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>12.700480883397598</x>
        <y>25.9972619609078</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>19.599994178815408</x>
        <y>25.62629276605567</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype839</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>20.83150891566898 0.0 0.0 20.83150891566898 -146.93381711941683 -413.69827027663257</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[COOJA_DIR]/build/scripts/startup.js</scriptfile>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
